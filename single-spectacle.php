<?php
/**
 * Template Name: Single spectacle
 */
    ...
    if ($query->have_posts()) {
        ...
        while ($query->have_posts()) {
            ...
            $complete_spectacle_url = home_url(get_field('type_name'));
            $spectacleEventID = url_to_postid($complete_spectacle_url);

            if (get_field('event-type') == 'spectacle' && $spectacleEventID == $context['post']->ID ) {
    ...
    Timber::render( array( 'single-spectacle.twig' ), $context );